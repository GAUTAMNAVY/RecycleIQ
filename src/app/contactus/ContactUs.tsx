...
const ContactUs = () => {
  ...
  return (
    <div suppressHydrationWarning={true as any}>
      <br/><br/><br/>
      <Head>
      <title>Recycle Right - ContactUs</title> </Head><div className="px-4 w-full py-16 lg:py-24 md:pb-32 md:container">
      <ToastContainer
        className="text-2xl"
        position="top-right"
        autoClose={3000}
            ...
            <ul className="footer footer-list">
              ...
              <li className="footer-item">
                ...
                <Link
                  target="_blank"
                  rel="noopener noreferrer"
                  href="mailto:navygautam33@gmail.com"
                  className="contact-link"
                >
                  navygautam33@gmail.com
                </Link>
              </li>
              <li className="footer-item">
                <ul className="social-list mb-4 md:mb-0">
                  <li>
                    <Link
                      target="_blank"
                      rel="noopener noreferrer"
                      href="https://www.linkedin.com/in/navy-gautam-0247b1249/"
